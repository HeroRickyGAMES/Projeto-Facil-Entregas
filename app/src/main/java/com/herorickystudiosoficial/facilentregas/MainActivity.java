...
public class MainActivity extends AppCompatActivity {
    ...
    private String UID, nomeUser, lojaName, productName, lojaLocal, statusconta, entregaLocal, preco, statusDoProduto, entreguePor, uidEntregador, latDb, longDB, lat, log, userLatitude, userLongitude, EndereçoEntregador, productID;
